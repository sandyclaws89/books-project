...
var adminView = document.getElementById('admin-view').addEventListener("click", displayDate);
...
adminView.addEventListener("click", function () {
  if (adminTab.style.display == "none") {
    adminTab.style.display = "block"; // my_toggle_button[i].innerHTML = "- show less";
    //my_toggle_array[i] = 1;
  } else {
    adminTab.style.display = "none"; // my_toggle_button[i].innerHTML = "+ show more";
    //my_toggle_array[i] = 0;
  }
...
__webpack_require__(/*! C:\Users\Paolo\Documents\Boolean\books-project\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\Paolo\Documents\Boolean\books-project\resources\sass\app.scss */"./resources/sass/app.scss");
